...
public class TestServiceIntent extends IntentService {
    ...
    private static final String EXTRA_PARAM2 = "com.example.test07.extra.PARAM2";

    // --------------------------------------------------------
    // variables
    // --------------------------------------------------------
    private static final String TAG = "my_app - " + TestServiceIntent.class.getSimpleName();
    public static final String ACTION_STATUS_BAR_ONLY = "com.example.test07.action.STATUS_BAR_ONLY";
    public static final String ACTION_STATUS = "com.example.test07.action.STATUS";
